      ...
      >
        ...
        <Listbox.Button
          className={clsx(
            ...
            {
              "hover:border-transparent active:border-transparent text-neutral-500":
                disabled,
        ...
        <Listbox.Options
          className={`w-48 block absolute left-1/2 -translate-x-1/2 z-10 bg-neutral-700 mt-2 rounded-sm ${listboxOptionsClassName}`}
        >
          {options.map((option) => (
            <Listbox.Option
              key={option.id}
