  ...
  if (validParams) {
    ...
    return (
      <div className="flex flex-col px-96 mt-8 justify-center">
        <p className="text-center text-2xl font-bold text-neutral-100">Invalid Chess Settings</p>
        <HRule />
        <p>The settings in the URL are invalid. Click <Link href='/play/chess' className='font-bold hover:underline'>here</Link> to go back to the settings page.</p>
      </div>
    );
  }
}