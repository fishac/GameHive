...
const std::array<int,20> kingSafetyPenalties = {{
	0, 0, 1, 2, 5, 10, 17, 28,
	40, 60, 80, 107, 120, 130, 135, 137, 
	140, 142, 143, 143
}};

const std::array<int,7> earlygameMobilityWeights = {{0, 0, 5, 4, 2, 2, 0}};
const std::array<int,7> endgameMobilityWeights = {{0, 0, 3, 2, 5, 6, 0}};
